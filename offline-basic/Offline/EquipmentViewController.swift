...
class EquipmentViewController: UIViewController, URLSessionTaskDelegate, UITableViewDataSource, UITableViewDelegate, ActivityIndicator {
    ...
    let objectCellId = "EquipmentCellID"
